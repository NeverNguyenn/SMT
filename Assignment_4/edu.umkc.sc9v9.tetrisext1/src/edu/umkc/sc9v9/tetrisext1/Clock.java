...
public class Clock implements IClock {
	...
	public Clock(){
		//this.millisPerCycle = 1000.0f;
		//this.millisPerCycle=this.setCyclesPerSecond(1.0f);
		this.millisPerCycle = (1.0f / 1.0f) * 1000;
		this.reset();
		System.out.println("From First Extension");
	}
	
	public Clock(float cyclesPerSecond) {
		System.out.println("Parameterized constructor of Clock");
