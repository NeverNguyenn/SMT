...
//	private IRandomTile ike;
	...
	public void startGame() {
		...
		IConfigurationElement[] config1 = Platform.getExtensionRegistry()
				.getConfigurationElementsFor(
						"edu.umkc.sc9v9.tetrisextp2");// Change to
																	// fit your
																	// own
		Object obj1 = null;
		try {
			for (IConfigurationElement e : config1) {
				System.out.println("Harsha Evaluating extension of Clock");
				obj1 = e.createExecutableExtension("keyevent");
		...
		IRandomTile ike = (IRandomTile) obj1;
		
		this.random = ike.getRandom();
		this.isNewGame = true;
		this.gameSpeed = 1.0f;
		...
		IConfigurationElement[] config2 = Platform.getExtensionRegistry()
				.getConfigurationElementsFor(
						"edu.umkc.sc9v9.tetrisextp1");// Change to
																	// fit your
																	// own
		Object obj2 = null;
		try {
			for (IConfigurationElement e : config2) {
				System.out.println("Harsha Evaluating extension of Clock");
				obj2 = e.createExecutableExtension("class");
