...
import edu.umkc.sc9v9.tetris.boardpanel.BoardPanelImp;
import edu.umkc.sc9v9.tetris.sidepanel.SidePanelImp;
import edu.umkc.sc9v9.tetris.clock.ClockImp;

public class TetrisImp extends JFrame implements ITetrisImp
{
	public TetrisArch _arch;
...
/**
	...
	*/	
	...
	public void begin(){
		setArch(_arch);
		//TODO Auto-generated method stub
		TetrisImp tetris = new TetrisImp();
		tetris.startGame();
		_arch.OUT_IClock.setCyclesPerSecond(gameSpeed);
		_arch.OUT_ISidePanel.paintComponent(g);
